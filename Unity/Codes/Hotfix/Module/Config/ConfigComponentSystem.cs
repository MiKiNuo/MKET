...
namespace ET
{
    ...
    public static class ConfigComponentSystem
	{
		public static void LoadOneConfig(this ConfigComponent self, Type configType)
		{
			...
			object category = MessagePackHelper.FromBytes(configType, oneConfigBytes, 0, oneConfigBytes.Length);//ProtobufHelper.FromBytes(configType, oneConfigBytes, 0, oneConfigBytes.Length);
